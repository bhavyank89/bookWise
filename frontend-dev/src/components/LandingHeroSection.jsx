...
function LandingHeroSection({ openModal }) {
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between px-8 lg:px-16 py-16 gap-12 relative z-10">
                <div className="lg:w-1/2 space-y-8 text-center lg:text-left">
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="bg-[#F79B72] flex items-center gap-2 text-black px-6 py-3 rounded-full text-lg font-semibold transition duration-300 shadow-md cursor-pointer hover:bg-orange-500 mx-auto lg:mx-0"
                        onClick={openModal}
                    >
                        Get Started
                        <motion.div
