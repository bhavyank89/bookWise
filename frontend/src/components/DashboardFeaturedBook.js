...
function DashboardFeaturedBook({
    ...
    useEffect(() => {
        if (featuredBooks.length > 1 && !loading) {
    ...
    }, [featuredBooks, loading, setFeaturedBook]);
                    ...
                    {featuredBook && (
                        ...
                        >
                            ...
                            <div className="max-w-[450px]">
                                ...
                                <Button
                                    onClick={() => {
                                        console.log("Borrow book requested"); // Replace with real borrow handler
                                    }}
                                    className="bg-[#f5c784] hover:bg-[#f1b65f] text-black font-semibold"
                                >
                                    📖 Borrow Book Request
                                </Button>
                            </div>
