...
const CombinedLandingPage = () => {
    ...
    return (
        <div className="min-h-screen font-sans text-gray-800 bg-gray-900">
            ...
            <RoleModal closeModal={closeModal} setSelectedRole={setSelectedRole} selectedRole={selectedRole} handleContinue={handleContinue} isModalOpen={isModalOpen} setIsModalOpen={setIsModalOpen} />
